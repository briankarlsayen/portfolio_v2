...
const About = () => {
  ...
  return (
    <div id="about" className='bg-secondary'>
      <div className={`min-h-screen max-w-2xl flex flex-col mx-auto justify-center x-spacing md:px-0 animate ${techVisible ? 'appear' : 'disappear'}`} ref={techRef}>
        <h4 className='uppercase text-sm text-white tracking-widest'>About</h4>
        <h2 className="text-3xl pb-6  hero-title">Introduction</h2>
